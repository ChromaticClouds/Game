 ...
 * Detect Collision
 */
function checkCollision(player: Player, obstacle: Obstacle) {
  return (
...
window.addEventListener("keydown", (e) => {
  ...
  if (e.code === "ArrowDown" || e.code === "KeyS") player.slideDown();
});

window.addEventListener("keyup", (e) => {
  if (e.code === "ArrowDown" || e.code === "KeyS") player.stopSlide();
});
