...
export const gameOverText = document.getElementById("game-over") as HTMLDivElement;
export const restartButton = document.getElementById("restart-button") as HTMLButtonElement;
export const totalScore = document.getElementById("total-score") as HTMLParagraphElement;
export const mainScreen = document.querySelector(".main-screen") as HTMLElement;
export const playButton = document.getElementById("play-button") as HTMLDivElement;
export const pointer = document.querySelector('.pointer') as HTMLDivElement;
